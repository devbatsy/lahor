            ...
            __c(
                ...
                [
                    __c(
                        'div',
                        {
                            style:`position:absolute;top:0;left:0;height:80%;width:70%;background-image:url("../assets/img.jpg");background-position:center 0;`,
                            class:'thin_border'
                    ...
                    __c(
                        'div',
                        {
                            style:`position:absolute;top:50%;left:20%;height:calc(100% - 50%);width:calc(100% - 20%);background-image:url("../assets/img.jpg");background-position:center 0;`,
                            class:'thin_border'
                        },[],{genericStyle:['bg_cover']}
                    )
                ]
