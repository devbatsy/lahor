...
sydDOM.page3_child1 = ({content,title,align} = {}) =>{
    return createElement(
        'div',
        {
...
sydDOM.broadImg = ({align = ''} = {}) =>{
    return createElement(
        'div',
        {
            style:`height:100%;width:100%;min-height:400px;max-height:400px;background-position:${preState(['hsec6_text_img_array','show'],false) === false ? (align == 'left' ? '200px' : '-200px') : '0'} 0;background-image:url("../assets/img.jpg");border-radius:25px;border-width:1px;box-shadow:0 2px 5px #000 inset;`,
            class:'thin_border'
        },[],{
            events:{
                // onmouseover:(e) =>{
