...
__SYD.gallery_feature_images_comp = () =>{
    return __c(
        'div',{
            style:`height:100%;min-height:fit-content;width:100%;padding:5px;display:flex;flex-direction:${__p(['hsec5_img_gallery_static','flex_param'],'row')};align-items:center;column-gap:10px;`,
        },
        [
            ...
            __c(
                ...
                [
                    ...
                    __c(
                        ...
                        [
                            __SYD.gallery_feature_images_comp_child3(),
                            __SYD.gallery_feature_images_comp_child3(),
                        ]
                    )
                ]
...
__SYD.gallery_feature_images_comp_child1 = () =>{
    return __c(
        'div',
        {
            style:`height:70vw;width:${__p(['hsec5_img_gallery_static','flex_param'],'row') === 'row' ? '30%' : '70%'};min-width:250px;max-height:380px;background-position:center 0;background-image:url("../assets/img.jpg");`+__sC['border-rad-15'](),
            class:'thin_border'
...
__SYD.gallery_feature_images_comp_child2 = () =>{
    return __c(
        'div',
        {
            style:`min-height:${__p(['hsec5_img_gallery_static','flex_param'],'row') === 'row' ? '50%' : '33vw'};width:100%;background-position:center 0;background-image:url("../assets/img.jpg");`+__sC['border-rad-15'](),
            class:'thin_border'
        },[],{genericStyle:['bg_cover']}
    )
}
...
__SYD.gallery_feature_images_comp_child3 = () =>{
    return __c(
        'div',
        {
            style:`height:100%;width:${__p(['hsec5_img_gallery_static','flex_param'],'row') === 'row' ? '50%' : '100%'};background-position:center 0;background-image:url("../assets/img.jpg");`+__sC['border-rad-15'](),
            class:'thin_border'
        },[],{genericStyle:['bg_cover']}
    )
}