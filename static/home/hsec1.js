    ...
    return __c(
        ...
        ],
        {
            createState:{
                ...
                state:{font:'45px',mode:'1',bgImg:'img.jpg',flex:true}
            },
            mediaQuery:{
